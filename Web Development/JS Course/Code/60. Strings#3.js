...
function getKeywordsAsString(books) {
  ...
  for (const i of books) {
    bookKeywords += i.keywords.toString();
  }
  return bookKeywords.split(",").join(";");
}
...
function logBookChapters(bookChapter) {
  for (const i of bookChapter) {
    console.log(`${i[0]}`.padEnd(20, "_") + `${i[1]}`.padStart(5, "_"));
  }
}
